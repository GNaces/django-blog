...
DATABASES = {
    'default': dj_database_url.parse(os.environ.get("DATABASE_URL", "postgres://uanse07nur6:Te5PIqK29CZN@ep-gentle-mountain-a23bxz6h-pooler.eu-central-1.aws.neon.tech/poise_crumb_both_806810"))
}
